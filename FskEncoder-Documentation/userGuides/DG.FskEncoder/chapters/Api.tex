...
\begin{sidewaysfigure}
		...
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../_images/seq.UserInteraction.png}
...
Figure \fullref{fig:seq-UserInteraction} depicts how the application and the different parts of an extension work together.
...
\begin{sidewaysfigure}
		...
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../_images/seq.LoadExtensions.png}
...
\figref{fig:seq.LoadExtensions} shows the sequence diagram of the creation of an Input-ReaderExtension and TargetsystemExtension.
...
\begin{sidewaysfigure}
		...
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../_images/cls.target.z80trainer.png}
...
\figref{fig:cls-target-z80trainer} shows the class diagram of the Z80-Trainer extension as an example of how an target system extension is to build.
...
Please go to section \fullref{ProtocolImplementation} to learn how to implement a protocol.
...
\begin{sidewaysfigure}
		...
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../_images/cls.ext.source.bin.png}
...
This class is registered in the Extension.properties and should be named according to the rules previously stated in section \fullref{TargetSystemExtension}.
