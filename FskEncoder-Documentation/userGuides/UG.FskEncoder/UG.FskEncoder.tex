...
\begin{minipage}{0.45\textwidth}
	...
	\adjustimage{width=\textwidth, valign=t}{../_images/UG.Mainwindow.png}
...
\begin{enumerate}
	...
	\begin{minipage}{0.35\textwidth}
		...
		\adjustimage{width=\textwidth, valign=l}{../_images/Mnu.Preference.png}
...
\includegraphics[width=0.5\textwidth]{../_images/Dlg.SelectTargetSystem.png} 
\includegraphics[width=0.5\textwidth]{../_images/Ddl.TargetSystems.png} 
\\
...
\includegraphics[width=0.5\textwidth, valign=t]{../_images/Dlg.SelectOutputDevice.png} 
\includegraphics[width=0.5\textwidth, valign=t]{../_images/Ddl.OutputDevices.png} 
\\
...
\begin{minipage}{0.35\textwidth}
	...
	\adjustimage{width=\textwidth, valign=l}{../_images/Dlg.SelectDefaultPath.png}
...
\includegraphics[width=0.5\textwidth]{../_images/Pnl.OutputControl.png} 

%===============================================================================

\subsection{Source File selector (4)}

\includegraphics[width=0.5\textwidth]{../_images/Pnl.SourceFileSelector.png} 
\vspace{1em}
\hfill \break
\begin{minipage}{0.58\textwidth}
...
\begin{minipage}{0.35\textwidth}
	...
	\adjustimage{width=\textwidth, valign=l}{../_images/Dlg.SelectFile.png}
...
\begin{minipage}{0.45 \textwidth}
	...
	\adjustimage{width=\textwidth, valign=l}{../_images/Pnl.SourceFileInfo.png} 
	%\vspace{1em}
	%\hfill \break
...
\includegraphics[width=0.5\textwidth]{../_images/Pnl.UploadControl.png} 
%\vspace{1em}
\hfill \break
...
\includegraphics[width=0.5\textwidth]{../_images/Pnl.StatusBar.png} 
%\vspace{1em}
\hfill \break
...
\begin{minipage}{0.48\textwidth}
	...
	\adjustimage{width=\textwidth, valign=r, center}{../_images/Pnl.TargetExtension-MpfI.png}
...
\begin{minipage}{0.48\textwidth}
	...
	\adjustimage{width=\textwidth, valign=r, center}{../_images/Pnl.TargetExtension-Z80Trainer.png}
...
\begin{minipage}{0.48\textwidth}
	...
	\adjustimage{width=\textwidth, valign=r}{../_images/Pnl.TargetExtension-BinReader.png}
...
\begin{minipage}{0.48\textwidth}
	...
	\adjustimage{width=\textwidth, valign=r}{../_images/Pnl.TargetExtension-Ihx8Reader.png}
